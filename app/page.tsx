...
export default function Home() {
  ...
  const demoImages = ["https://s3.twcstorage.ru/3ad44efa-dd30-4e72-a42f-9e646d39c1c8/dentist-1.jpg", "https://s3.twcstorage.ru/3ad44efa-dd30-4e72-a42f-9e646d39c1c8/dentist-2.jpg", "https://s3.twcstorage.ru/3ad44efa-dd30-4e72-a42f-9e646d39c1c8/dentist-3.jpg", "https://s3.twcstorage.ru/3ad44efa-dd30-4e72-a42f-9e646d39c1c8/dentist-4.jpg"];
  ...
  return (
    <main style={{ fontFamily: "Arial", overflowX: "hidden", background: bgColor, minHeight: "100vh" }}>
      ...
      <section style={{ padding: isMobile ? "10px 15px" : "20px 20px", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <img src="https://s3.twcstorage.ru/3ad44efa-dd30-4e72-a42f-9e646d39c1c8/dental-header.png" alt="header" style={{ width: "100%", height: "auto", borderRadius: 20 }} />
        </div>
      </section>
